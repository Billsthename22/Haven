...
const posts = [
  {
    user: "David", initials: "D", color: "#10b981",
    community: "The Boys",
    content: "Movie night this weekend? 🍿 Who's in?",
    likes: 24, comments: 12, time: "2h ago", liked: false,
  },
  {
    user: "Tolu", initials: "T", color: "#8b5cf6",
    community: "Babcock Crew",
    content: "Just uploaded all the graduation photos 📸",
    likes: 42, comments: 18, time: "5h ago", liked: true,
  },
];
    ...
    <div style={{
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sh-trend-row:hover { background: #101010 !important; border-radius: 8px; }
      `}</style>
          ...
          {navItems.slice(0,4).map(({ icon: Icon, label }) => {
            ...
            return (
              <button key={label} className="sh-nav-btn" onClick={() => setActiveTab(label)} style={{
                ...
                color: active ? "#fff" : "#484848", fontWeight: active ? 500 : 400, fontSize: 13,
                position: "relative",
              }}>
      ...
      <main style={{ flex: 1, overflowY: "auto", minWidth: 0 }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <span style={{ fontWeight: 600, fontSize: 14, color: "#fff" }}>Good evening, Emi</span>
              <span className="sh-hdr-sub" style={{ color: "#383838", marginLeft: 8, fontSize: 13 }}>What's happening in your circles?</span>
            </div>
          </div>
          ...
          <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 26 }}>
            ...
            <div className="sh-hero" style={{
              ...
              <div style={{ position: "relative" }}>
                ...
                <div style={{ color: "#383838", marginTop: 8, fontSize: 13, lineHeight: 1.6, maxWidth: 320 }}>
                  Your circles are active. Keep the momentum going.
                </div>
                <div style={{ display: "flex", gap: 8, marginTop: 18 }}>
                  ...
                  <button style={{
                    ...
                    background: "none", border: "1px solid #1c1c1c", borderRadius: 7,
              ...
              <div className="sh-actions-row" style={{ display: "grid", gridTemplateColumns: "repeat(6,1fr)", gap: 8 }}>
                {quickActions.map(({ icon: Icon, label, accent }, i) => (
                  <button key={i} className="sh-action-btn" style={{
                    ...
                    borderRadius: 10, cursor: "pointer", color: "#484848", fontSize: 11, fontWeight: 500,
                ...
                {communities.map((c) => (
                  <div key={c.name} className="sh-circle-card" style={{
                    ...
                    <div style={{
                      ...
                      border: "1px solid " + c.hue + "28",
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontWeight: 700, fontSize: 12, color: c.hue, marginBottom: 12,
                    }}>{c.initials}</div>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {posts.map((post, i) => (
                  <div key={i} className="sh-post-card" style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                      <div style={{ position: "relative" }}>
                        <div style={{
                          width: 36, height: 36, borderRadius: 9, background: post.color + "20",
                          border: "1.5px solid " + post.color + "40",
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontWeight: 700, fontSize: 13, color: post.color,
                        }}>{post.initials}</div>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                          ...
                          <span style={{ fontSize: 10, padding: "2px 7px", borderRadius: 4, background: "#121212", color: "#484848", border: "1px solid #1e1e1e" }}>
                            {post.community}
                          </span>
                        </div>
                    ...
                    <div style={{
                      ...
                      justifyContent: "center", marginBottom: 14, position: "relative", overflow: "hidden",
                    }}>
                      <ImageIcon size={24} color="#212121" />
                      <div style={{
                        position: "absolute", bottom: 8, right: 8, display: "flex", alignItems: "center", gap: 4,
                        background: "rgba(0,0,0,0.6)", fontSize: 10, color: "#666", padding: "3px 8px", borderRadius: 4,
                      }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ display: "flex", gap: 4 }}>
                        <button onClick={() => toggleLike(i)} style={{
                          ...
                          borderColor: likedPosts[i] ? "#f43f5e30" : "#141414",
                          background: likedPosts[i] ? "#f43f5e10" : "transparent",
                          cursor: "pointer", color: likedPosts[i] ? "#f43f5e" : "#444",
                        ...
                        <button style={{
                          display: "flex", alignItems: "center", gap: 5, padding: "6px 10px",
                          borderRadius: 6, border: "1px solid #141414",
                          background: "transparent", cursor: "pointer", color: "#444", fontSize: 12, fontWeight: 500,
                        }}>
                      ...
                      <button style={{
                        display: "flex", alignItems: "center", gap: 5, padding: "6px 10px",
                        borderRadius: 6, border: "1px solid #141414",
                        background: "transparent", cursor: "pointer", color: "#444", fontSize: 12,
                      }}>
          ...
          <div className="sh-right" style={{ width: 248, flexShrink: 0, flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {onlineUsers.map((f, i) => (
                  <div key={i} style={{
                    ...
                    borderBottom: i < onlineUsers.length - 1 ? "1px solid #0f0f0f" : "none",
                  }}>
                    <div style={{ position: "relative" }}>
                      <div style={{
                        width: 32, height: 32, borderRadius: 8, background: f.color + "18",
                        display: "flex", alignItems: "center", justifyContent: "center",
                        fontWeight: 700, fontSize: 12, color: f.color,
                      }}>{f.name[0]}</div>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 10, color: "#383838", marginTop: 1, display: "flex", alignItems: "center", gap: 3 }}>
                        {f.status === "Listening to music" ? <Radio size={9} color="#383838" /> : <div style={{ width: 5, height: 5, borderRadius: "50%", background: "#10b981" }} />}
                        {f.status}
                      </div>
                    </div>
                  </div>
            ...
            <div style={{ background: "#0b0b0b", border: "1px solid #141414", borderRadius: 12, padding: "16px" }}>
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center", marginBottom: 12 }}>
                <div style={{
                  width: 44, height: 44, borderRadius: 8, background: "#10b98118",
                ...
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontWeight: 600, fontSize: 13, color: "#e0e0e0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>Not Like Us</div>
                  <div style={{ fontSize: 11, color: "#484848", marginTop: 1 }}>Kendrick Lamar</div>
                  <div style={{ fontSize: 10, color: "#10b981", marginTop: 5, display: "flex", alignItems: "center", gap: 4 }}>
                    <Play size={9} fill="#10b981" strokeWidth={0} /> Shared by David
                  </div>
                </div>
              </div>
              <div style={{ height: 2, background: "#141414", borderRadius: 1, overflow: "hidden" }}>
                <div style={{ width: "38%", height: "100%", background: "#10b981", borderRadius: 1 }} />
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 5 }}>
                <span style={{ fontSize: 9, color: "#2a2a2a" }}>1:24</span>
                <span style={{ fontSize: 9, color: "#2a2a2a" }}>3:41</span>
              </div>
            </div>
